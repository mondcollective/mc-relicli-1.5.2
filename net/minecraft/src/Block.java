...
public class Block
{
    ...
    {
    	return Reliant.getInstance().getModuleHelper().getBlockBrightnessHook(this, 
        		par1IBlockAccess.getBrightness(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]));
    }
    ...
    {
    	return Math.round(Reliant.getInstance().getModuleHelper().getBlockBrightnessHook(this, 
        		par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)])));
    }
    ...
    {
        return Reliant.getInstance().getModuleHelper().renderBlockPassHook(this);
    }
