...
import net.minecraft.reliant.override.OvGuiNewChat;
...
public class GuiIngame extends Gui
{
    ...
    public GuiIngame(Minecraft par1Minecraft)
    {
        ...
        this.persistantChatGUI = new OvGuiNewChat(par1Minecraft);
    }
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
        	...
        	Reliant.getInstance().getEventManager().fireEvent(new EventInGame(var8, var6, var7));
        }
        ...
        EventDrawChat event = new EventDrawChat(this.updateCounter);
