...
public class EntityOtherPlayerMP extends EntityPlayer
{
    ...
    {
    	String name = Reliant.getInstance().relFont.stripControlCodes(this.username);
    	...
    	if(!name.equalsIgnoreCase(Reliant.getInstance().relFont.stripControlCodes(this.username))
    			|| Reliant.getInstance().getNameProtect().containsName(name)) {
    		friend = true;
    	}
    	if(friend) {
    		this.cloakUrl = "http://i.imgur.com/NhRmfl3.png";
    	} else {
