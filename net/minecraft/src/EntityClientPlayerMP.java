...
public class EntityClientPlayerMP extends EntityPlayerSP
{
    ...
    {
    	Reliant.getInstance().getEventManager().fireEvent(new EventUpdate());
        ...
        EventMovementUpdate eventMovementUpdate =
        		(EventMovementUpdate) Reliant.getInstance().getEventManager().fireEvent(
        				new EventMovementUpdate());
        if(eventMovementUpdate.isEventCancelled()) {
        ...
        Reliant.getInstance().getEventManager().fireEvent(new EventPostUpdate());
    }
    ...
    {
    	EventChatSend event = new EventChatSend(par1Str);
