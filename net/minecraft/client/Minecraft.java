...
import net.minecraft.reliant.override.OvGuiChat;
...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    public void startGame() throws LWJGLException
    {
        ...
        Reliant.getInstance().getEventManager().fireEvent(new EventStartup());
    ...
    public void displayGuiScreen(GuiScreen par1GuiScreen)
    {
        ...
        {
        	par1GuiScreen = new OvGuiMainMenu();
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        {
                        	Reliant.getInstance().getEventManager().fireEvent(new EventKey(Keyboard.getEventKey()));
            ...
            {
                this.displayGuiScreen(new OvGuiChat());
            }
